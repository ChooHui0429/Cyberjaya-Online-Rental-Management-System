...
public class RemoveUser {
    public static void RejectUserData(
        String name, 
        String email, 
        String securityPassword,
        String acc_type,
        String userID,
        String loginPassword) throws IOException{
        ...
        try{
            ...
            // Create a reader 
            Reader reader = Files.newBufferedReader(Paths.get("Cyberjaya-Online-Rental-Management-System/Data/removedData.json"));

            // Convert JSON array to list of removed datas
            List<AccountData> removedDatas = gson.fromJson(reader, new TypeToken<List<AccountData>>(){}.getType());
            reader.close();
