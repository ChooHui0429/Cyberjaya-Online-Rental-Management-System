...
public class ApproveUser{
    ...
    public static void ApproveUserData(
        String name, 
        String email, 
    ...
    public static void RejectUserDataToJson(RegisterData newRejectData){
        try{
            ...
            // Create a reader 
            Reader reader = Files.newBufferedReader(Paths.get("Cyberjaya-Online-Rental-Management-System/Data/rejectedData.json"));

            // Convert JSON array to list of rejected datas
            List<RegisterData> rejectedDatas = gson.fromJson(reader, new TypeToken<List<RegisterData>>(){}.getType());
            reader.close();
