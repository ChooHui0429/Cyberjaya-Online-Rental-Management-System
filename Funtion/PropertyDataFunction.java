...
public class PropertyDataFunction {
    public static void NewPropertyUpload(
        ...
        Gson gson = new Gson();
        // Create a reader 
        Reader reader = Files.newBufferedReader(Paths.get("Cyberjaya-Online-Rental-Management-System/Data/propertyData.json"));
        ...
        // Create writer
        Writer writer = Files.newBufferedWriter(Paths.get("Cyberjaya-Online-Rental-Management-System/Data/propertyData.json"));
