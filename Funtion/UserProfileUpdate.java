...
public class UserProfileUpdate {
    ...
    public static void SaveupdateData(String userID, String new_Name, String new_Email, String new_ContactNumber) throws IOException{

        // Create Json instance
        Gson gson = new Gson();

        // Create a reader 
        Reader readerAcc = Files.newBufferedReader(Paths.get("Cyberjaya-Online-Rental-Management-System/Data/accountData.json"));
        Reader readerContactNum = Files.newBufferedReader(Paths.get("Cyberjaya-Online-Rental-Management-System/Data/userContactNumber.json"));
 
        // Convert JSON array to list
        List<AccountData> accountDatas = gson.fromJson(readerAcc, new TypeToken<List<AccountData>>(){}.getType());
        readerAcc.close();
        List<UserContactNumData> userContactDatas = gson.fromJson(readerContactNum, new TypeToken<List<UserContactNumData>>(){}.getType());
        ...
        // Create writer
        Writer writerContactNum = Files.newBufferedWriter(Paths.get("Cyberjaya-Online-Rental-Management-System/Data/userContactNumber.json"));
        // Convert new user contact datas to Json file
        gson.toJson(userContactDatas, writerContactNum);
        writerContactNum.close();

        // Create writer
        Writer writerAcc = Files.newBufferedWriter(Paths.get("Cyberjaya-Online-Rental-Management-System/Data/accountData.json"));
    ...
    public static UserContactNumData getContactData(String userID) throws IOException{
        ...
        // Create a reader 
        Reader reader = Files.newBufferedReader(Paths.get("Cyberjaya-Online-Rental-Management-System/Data/userContactNumber.json"));

        // Convert JSON array to list of user contact datas
        List<UserContactNumData> userContactDatas = gson.fromJson(reader, new TypeToken<List<UserContactNumData>>(){}.getType());
        reader.close();
        ...
        if(contact_data.getUserID().equals("")){
            ...
            // Create writer
            Writer writer = Files.newBufferedWriter(Paths.get("Cyberjaya-Online-Rental-Management-System/Data/userContactNumber.json"));
            // Convert new user contact datas to Json file
